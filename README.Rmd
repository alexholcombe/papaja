...
Please cite `papaja` if you use it (`citation('papaja')` will provide the reference). Below are some of the peer-reviewed publications that used it. If you have published a paper that was written with `papaja`, you can add the reference to the [public Zotero group](https://www.zotero.org/groups/2202906/papaja) yourself or send it to me.
